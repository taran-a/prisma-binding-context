...
var Prisma = /** @class */ (function (_super) {
    ...
    function Prisma(_a) {
        var typeDefs = _a.typeDefs, endpoint = _a.endpoint, secret = _a.secret, fragmentReplacements = _a.fragmentReplacements, debug = _a.debug, disableCache = _a.disableCache;
        var _this = this;
        if (!typeDefs) {
            throw new Error('No `typeDefs` provided when calling `new Prisma()`');
        }
        if (typeDefs.endsWith('.graphql')) {
            typeDefs = cache_1.getCachedTypeDefs(typeDefs, disableCache);
        }
